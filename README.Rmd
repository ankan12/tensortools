...
For the tensor variate normal inverse Gaussian distribution, we let $W \sim \mathrm{IG}(1, \kappa)$.
...
For the tensor variate skewed t distribution, we let $W \sim \mathrm{Inv\text{-}Gamma}(\nu/2, \nu/2)$.
