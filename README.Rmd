...
Below is a simulation from a tensor variate normal of size $3 \times 4 \times 2$. The covariance structure is specified with a list of matrices. 
...
and the covariance matrices were the identity.
...
```{r}
avg_invgauss_est <- with(invgauss_est, mu + skew/kappa)
avg_invgauss_true <- mu_true + skew_true/kappa_true

mean((avg_invgauss_est - avg_invgauss_true)^2)
```
